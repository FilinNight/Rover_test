...
- Вам пришли данные о местности в закодированном виде: фотография, сконвертированная в матрицу из строк в которой хранятся числа, и знаки X (X - обозначение, что прохода нет). 
